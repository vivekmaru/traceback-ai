...
- Treat broad nouns and plumbing fields such as `security`, `request`, `PRs`,
  `runId`, `record`, `decision`, `invalid`, `inReplyTo`, `accepted/edited`,
  `suffixing`, `page=<n>`, and generic `IDs` as suspicious in extraction
  heuristics. They need domain-specific failure verbs around them, not just
