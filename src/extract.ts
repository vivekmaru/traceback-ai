...
const CATEGORY_PATTERNS: Array<{
...
}> = [
  {
    ...
    patterns: [
      ...
      /\b(?:rule-decisions?|draft-rules?|export|rules?|runId|invalid|human-edited|human-editable).{0,80}\bmanual decision\b/i,
      /\bmanual decision\b.{0,80}\b(?:rule-decisions?|draft-rules?|export|rules?|runId|invalid|human-edited|human-editable)\b/i,
      /\bhuman-edited\b.{0,80}\b(?:rule-decisions?|draft-rules?|rules?|export|runId|manual decision|artifact|file)\b/i,
      /\b(?:rule-decisions?|draft-rules?|rules?|export|runId|manual decision|artifact|file)\b.{0,80}\bhuman-edited\b/i,
      /\bhuman-editable\b.{0,80}\b(?:rule-decisions?|draft-rules?|rules?|export|runId|manual decision|artifact|file)\b/i,
  ...
  },
  {
    ...
    patterns: [
      ...
      /\benriched records?\b.{0,80}\b(?:duplicate|collisions?|overwrites?|drops?|reused|candidate IDs?|sourceCandidateIds?)\b/i,
      /\b(?:duplicate|collisions?|overwrites?|drops?|reused|candidate IDs?|sourceCandidateIds?)\b.{0,80}\benriched records?\b/i,
      /\bsourceCandidateIds?\b.{0,80}\b(?:duplicate|collisions?|overwrites?|drops?|reused|record loss|preserve|disambiguat)\b/i,
      /\b(?:duplicate|collisions?|overwrites?|drops?|reused|record loss|preserve|disambiguat)\b.{0,80}\bsourceCandidateIds?\b/i,
      /\bcandidate IDs?\b.{0,80}\breused\b/i,
      /\breused\b.{0,80}\bcandidate IDs?\b/i,
      /\bmapRecordsByCandidateId\b/i,
      /\bsuffixing\b.{0,80}\b(?:IDs?|records?|candidates?|sourceCandidateIds?|entries)\b/i,
      /\b(?:IDs?|records?|candidates?|sourceCandidateIds?|entries)\b.{0,80}\bsuffixing\b/i,
    ],
  },
  {
    ...
    patterns: [
      ...
      /\b(?:review|comment|status|inference).{0,80}\bthread\b.{0,80}\b(?:reply|replies|status|resolved|outdated)\b/i,
      /\bthread\b.{0,80}\b(?:reply|replies|status|resolved|outdated).{0,80}\b(?:review|comment|status|inference)\b/i,
  ...
  },
  {
    ...
    patterns: [
      /\bper_page\b.{0,80}\b(?:import|imports|pulls?|PRs?|pagination|page size|above 100|more than 100|truncated|request|boundary)\b/i,
      /\b(?:import|imports|pulls?|PRs?|pagination|page size|above 100|more than 100|truncated|request|boundary)\b.{0,80}\bper_page\b/i,
      /\bpage size\b.{0,80}\b(?:import|imports|pulls?|PRs?|pagination|per_page|above 100|more than 100|truncated|request|boundary)\b/i,
      /\b(?:import|imports|pulls?|PRs?|pagination|per_page|above 100|more than 100|truncated|request|boundary)\b.{0,80}\bpage size\b/i,
      /\bpaginat(?:e|ed|ion)\b.{0,80}\b(?:import|imports|pulls?|PRs?|per_page|page size|above 100|more than 100|truncated|request)\b/i,
      /\b(?:import|imports|pulls?|PRs?|per_page|page size|above 100|more than 100|truncated|request)\b.{0,80}\bpaginat(?:e|ed|ion)\b/i,
      ...
      /\brequested PRs?\b.{0,80}\b(?:import|imports|pulls?|pagination|per_page|page size|above 100|more than 100|truncated|request|boundary)\b/i,
      /\b(?:import|imports|pulls?|pagination|per_page|page size|above 100|more than 100|truncated|request|boundary)\b.{0,80}\brequested PRs?\b/i,
      /\babove 100\b.{0,80}\b(?:import|imports|pulls?|PRs?|pagination|per_page|page size|truncated|request|boundary)\b/i,
      /\b(?:import|imports|pulls?|PRs?|pagination|per_page|page size|truncated|request|boundary)\b.{0,80}\babove 100\b/i,
      /\bmore than 100\b.{0,80}\b(?:import|imports|pulls?|PRs?|pagination|per_page|page size|truncated|request|boundary)\b/i,
      /\b(?:import|imports|pulls?|PRs?|pagination|per_page|page size|truncated|request|boundary)\b.{0,80}\bmore than 100\b/i,
      /\bsingle \/pulls page request\b/i,
      /\bsilently truncated\b.{0,80}\b(?:import|imports|pulls?|PRs?|pagination|per_page|page size|above 100|more than 100|request|boundary)\b/i,
      /\b(?:import|imports|pulls?|PRs?|pagination|per_page|page size|above 100|more than 100|request|boundary)\b.{0,80}\bsilently truncated\b/i,
    ],
  },
  {
