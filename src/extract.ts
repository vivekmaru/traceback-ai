...
const CATEGORY_PATTERNS: Array<{
  ...
  },
  {
    ...
    patterns: [
      ...
      /\bcollisions?\b.{0,80}\b(?:records?|sourceCandidateIds?|enriched records?|entries)\b/i,
      /\b(?:records?|sourceCandidateIds?|enriched records?|entries)\b.{0,80}\bcollisions?\b/i,
  ...
  },
  {
    ...
    patterns: [
      /\bper_page\b.{0,80}\b(?:import|imports|pulls?|PRs?|pagination|page size|above 100|more than 100|truncated|boundary)\b/i,
      /\b(?:import|imports|pulls?|PRs?|pagination|page size|above 100|more than 100|truncated|boundary)\b.{0,80}\bper_page\b/i,
      /\bpage size\b.{0,80}\b(?:import|imports|pulls?|PRs?|pagination|per_page|above 100|more than 100|truncated|boundary)\b/i,
      /\b(?:import|imports|pulls?|PRs?|pagination|per_page|above 100|more than 100|truncated|boundary)\b.{0,80}\bpage size\b/i,
      /\bpaginat(?:e|ed|ion)\b.{0,80}\b(?:import|imports|pulls?|PRs?|per_page|page size|above 100|more than 100|truncated)\b/i,
      /\b(?:import|imports|pulls?|PRs?|per_page|page size|above 100|more than 100|truncated)\b.{0,80}\bpaginat(?:e|ed|ion)\b/i,
