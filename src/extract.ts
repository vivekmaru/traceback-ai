...
const CATEGORY_PATTERNS: Array<{
  ...
  },
  {
    ...
    patterns: [
      ...
      /\bpaginat(?:e|ed|ion)\b.{0,80}\b(?:import|imports|pulls?|page size|above 100|more than 100|truncated)\b/i,
      /\b(?:import|imports|pulls?|page size|above 100|more than 100|truncated)\b.{0,80}\bpaginat(?:e|ed|ion)\b/i,
