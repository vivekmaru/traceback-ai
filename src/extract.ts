...
const CATEGORY_PATTERNS: Array<{
...
}> = [
  {
    ...
    patterns: [
      ...
      /\baccepted\/edited\b.{0,80}\b(?:rule-decisions?|draft-rules?|rules?|export|manual decision|artifact)\b/i,
      /\b(?:rule-decisions?|draft-rules?|rules?|export|manual decision|artifact)\b.{0,80}\baccepted\/edited\b/i,
    ],
  },
  {
    ...
    patterns: [
      ...
      /\b(?:records?|entries|candidate IDs?|sourceCandidateIds?)\b.{0,80}\boverwrites?\b/i,
      ...
      /\bsourceCandidateIds?\b.{0,80}\b(?:duplicate|collisions?|overwrites?|drops?|reused|record loss|disambiguat)\b/i,
      /\b(?:duplicate|collisions?|overwrites?|drops?|reused|record loss|disambiguat)\b.{0,80}\bsourceCandidateIds?\b/i,
