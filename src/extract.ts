...
const CATEGORY_PATTERNS: Array<{
...
}> = [
  {
    ...
    patterns: [
      ...
      /\b(?:rule-decisions?|draft-rules?|export|rules?|runId|human-edited|human-editable).{0,80}\bmanual decision\b/i,
      /\bmanual decision\b.{0,80}\b(?:rule-decisions?|draft-rules?|export|rules?|runId|human-edited|human-editable)\b/i,
  ...
  },
  {
    ...
    patterns: [
      ...
      /\benriched records?\b.{0,80}\b(?:duplicate|overwrites?|drops?|reused|candidate IDs?|sourceCandidateIds?)\b/i,
      /\b(?:duplicate|overwrites?|drops?|reused|candidate IDs?|sourceCandidateIds?)\b.{0,80}\benriched records?\b/i,
  ...
  },
  {
    ...
    patterns: [
      ...
      /\bpaginat(?:e|ed|ion)\b.{0,80}\b(?:import|imports|pulls?|per_page|page size|above 100|more than 100|truncated)\b/i,
      /\b(?:import|imports|pulls?|per_page|page size|above 100|more than 100|truncated)\b.{0,80}\bpaginat(?:e|ed|ion)\b/i,
